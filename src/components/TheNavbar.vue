    ...
    <div class="container flex flex-wrap justify-between items-center mx-auto">
      ...
      <div v-if="currentUser" class="flex md:order-2">
        ...
        <button
          @click="logout"
          type="button"
          class="ml-2 text-blue-700 shadow bg-white focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-blue-600"
        >
          Logout
        </button>
        <button
